							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{ route('register') }}" name="frm-login" method="POST">
									...
									<fieldset class="wrap-input">
										...
										<input type="text" id="frm-reg-lname" name="name" placeholder="Your name*" :value="name" required autocomplete="name" autofocus value="{{ old('name') }}">
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Email Address*</label>
										<input type="email" id="frm-reg-email" name="email" placeholder="Email address" :value="email" vlaue="{{ old('email') }}">
									</fieldset>
									<fieldset class="wrap-title">
