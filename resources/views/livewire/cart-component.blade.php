    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                        ...
                        @foreach(Cart::instance('cart')->content() as $item)
                            <li class="pr-cart-item">
                                ...
                                <div class="quantity">
                                    ...
                                    <div><p class="text-center"><a href="" wire:click.prevent="moveItemToSaveForLater('{{ $item->rowId }}')">Save for Later</a></p></div>
                                </div>
                ...
                @else
                    <p><strong>No item in the Cart</strong></p>
                @endif                
            </div>
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if (Session::has('coupon'))
                        ...
                        <p class="summary-info"><span class="title">Subtotal with Discount</span><b class="index">${{ $subtotal_after_discount }}</b></p>
                        <p class="summary-info"><span class="title">Vat ({{ config('cart.tax') }}%)</span><b class="index">${{ $tax_after_discount }}</b></p>
                        <p class="summary-info total-info "><span class="title">Total</span><b class="index">${{ $total_after_discount }}</b></p>
                    @else
                        <p class="summary-info"><span class="title">Vat ({{ config('cart.tax') }}%)</span><b class="index">${{ Cart::instance('cart')->tax() }}</b></p>
                ...
                <div class="checkout-info">
                    @if (!Session::has('coupon'))
                        <label class="checkbox-field">
                            <input class="frm-input " name="have-code" id="have-code" value="1" type="checkbox" wire:model="have_coupon_code"><span>I have promo code</span>
                        </label>
                        @if($have_coupon_code)
                            <div class="summary-item">
                                <form action="#" wire:submit.prevent="applyCouponCode()">
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input type="text" name="coupon-code" id="coupon-code" wire:model="coupon_code">
                                    </p>
            ...
            @else
                <div class="text-center" style="padding: 30px 0;">
                    ...
                    <p>Please add product(s) in cart</p>
            ...
            <div class="wrap-iten-in-cart">
                ...
                <h3 class="box-title">{{Cart::instance('saveForLater')->count()}} item(s) for Saved for later</h3>
                    ...
                    <ul class="products-cart">
                        @foreach(Cart::instance('saveForLater')->content() as $item)
                            <li class="pr-cart-item">
                                ...
                                <div class="delete">
                                    <a href="#" class="btn btn-delete" title="" wire:click.prevent="removeFromSaved('{{ $item->rowId }}')">
                                        <span>Delete from your saved</span>
                                        <i class="fa fa-times-circle" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </li>
                ...
                @else
                    <p><strong>No item saved for later</strong></p>
                @endif                
            </div>
