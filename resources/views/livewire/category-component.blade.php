            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item product-per-page" wire:model="page_size">
                        ...
                        <ul class="list-category">
                            @foreach($categories as $category)
                                <li class="category-item">
                                    <a href="{{ route('product.category', ['category_slug'=>$category->slug, 'category_id'=>$category->id]) }}" class="cate-link">{{ $category->name }}</a>
                                </li>
                            @endforeach                            
                        </ul>
                    </div>
