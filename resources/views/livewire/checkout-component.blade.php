                    ...
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="number" name="phone" value="" placeholder="10 digits format" wire:model="cell">
                                @error('cell')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </p>
                    ...
                    @if ($ship_to_different)
                        <div class="col-md-12">
                            <div class="wrap-address-billing">
                                ...
                                <p class="row-in-form">
                                    <label for="phone">Phone number<span>*</span></label>
                                    <input type="number" name="phone" value="" placeholder="10 digits format" wire:model="s_cell">
                                    @error('s_cell')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                    ...
                    <div class="summary-item payment-method">
                        ...
                        @if ($payment_method == 'card')
                            <div class="wrap-address-billing">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="exp_month" value="" placeholder="Your card's expire month" wire:model="exp_month">
                                    @error('exp_month')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="exp_year" value="" placeholder="Your card's expire year" wire:model="exp_year">
                                    @error('exp_year')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                                <p class="row-in-form">
                                    ...
                                    <input type="password" name="cvc" value="" placeholder="Your card's cvc" wire:model="cvc">
                                    @error('cvc')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                        ...
                        <div class="choose-payment-methods">
                            ...
                            <label class="payment-method">
                                ...
                                <span class="payment-desc">Pay with your debit or credit card.</span>
                            </label>
                            <label class="payment-method">
                        ...
                        @endif
                        <button type="submit" class="btn btn-info btn-medium">Place order now</button>
                    </div>
